...
class FirstExplosionParticle extends pixi_js.Graphics {
    vx;
    vy;
    lifetime;
    app;
    ...
    update() {
        ...
        const trailParticle = new pixi_js.Graphics();
...
class SecondExplosionParticle extends pixi_js.Graphics {
    vx;
    vy;
    lifetime;
    app;
...
class Firework {
    ...
    constructor(app, onExplodeCallback, secondaryExplosionDelay = 1000, firstExplosionParticleCount = 150, secondExplosionParticleCount = 30, fixedFireworkPosition, firstExplosionTimeTargetY, fireworkSpeedRange = { min: 5, max: 10 }, firstExplosionParticleSizeRange = {
        ...
        this.launched = false;
        this.exploded = false;
        this.fireworkDot = new pixi_js.Graphics();
